  ...
  getCalendarDays({
    ...
    for (let w = 1; w <= weeks; w++) {
      ...
      for (let i = 1, weekday = firstDayOfWeek; i <= daysInWeek; i++, weekday += weekday === daysInWeek ? 1 - daysInWeek : 1) {
        ...
        const id = `${Object(helpers["q" /* pad */])(year, 4)}-${Object(helpers["q" /* pad */])(month, 2)}-${Object(helpers["q" /* pad */])(day, 2)}`;
...
var CalendarNav_component = normalizeComponent(
  ...
  CalendarNavvue_type_template_id_cf693a5c_render,
  CalendarNavvue_type_template_id_cf693a5c_staticRenderFns,
  false,
  null,
  null,
  null
...
// EXTERNAL MODULE: ./src/components/CalendarDay.vue?vue&type=style&index=0&id=4bf08813&lang=postcss&scoped=true&
var CalendarDayvue_type_style_index_0_id_4bf08813_lang_postcss_scoped_true_ = __webpack_require__("608c");
...
// EXTERNAL MODULE: ./src/components/CalendarPane.vue?vue&type=style&index=0&id=ea3333ec&lang=postcss&scoped=true&
var CalendarPanevue_type_style_index_0_id_ea3333ec_lang_postcss_scoped_true_ = __webpack_require__("3c2e");
...
/* harmony default export */ var Calendarvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    canMovePrev() {
      return !Object(helpers["v" /* pageIsValid */])(this.minPage_) || Object(helpers["r" /* pageIsAfterPage */])(this.pages[0], this.minPage_);
    },

    canMoveNext() {
      return !Object(helpers["v" /* pageIsValid */])(this.maxPage_) || Object(helpers["s" /* pageIsBeforePage */])(this.pages[this.pages.length - 1], this.maxPage_);
    }
  ...
  watch: {
    ...
    fromPage(val) {
      ...
      if (Object(helpers["u" /* pageIsEqualToPage */])(val, firstPage)) return;
      this.refreshPages();
    },

    toPage(val) {
      const lastPage = this.pages && this.pages[this.pages.length - 1];
      if (Object(helpers["u" /* pageIsEqualToPage */])(val, lastPage)) return;
      this.refreshPages();
    },
  ...
  methods: {
    ...
    canMove(page) {
      return Object(helpers["t" /* pageIsBetweenPages */])(page, this.minPage_, this.maxPage_);
    },
    ...
    move(arg, opts = {}) {
      ...
      if (!opts.position) {
        if (Object(helpers["s" /* pageIsBeforePage */])(page, this.firstPage)) {
          opts.position = -1;
        } else if (Object(helpers["r" /* pageIsAfterPage */])(page, this.lastPage)) {
          opts.position = 1;
        } else {
      ...
      if (fromPage && !Object(helpers["u" /* pageIsEqualToPage */])(fromPage, this.firstPage)) {
    ...
    showPageRange(range, opts) {
      ...
      if (Object(helpers["r" /* pageIsAfterPage */])(toPage, lastPage)) {
        page = Object(helpers["a" /* addPages */])(toPage, -(this.pages.length - 1));
      } // But no earlier than the desired `fromPage`


      if (Object(helpers["s" /* pageIsBeforePage */])(page, fromPage)) {
        page = fromPage;
      }
    ...
    getTargetPageRange(page, {
      ...
      if (Object(helpers["v" /* pageIsValid */])(page)) {
        ...
        if (!Object(helpers["v" /* pageIsValid */])(fromPage)) {
          // 3. Try the toPage prop
          const toPage = this.toPage || this.pageForDate(this.toPage);

          if (Object(helpers["v" /* pageIsValid */])(toPage)) {
      ...
      fromPage = Object(helpers["v" /* pageIsValid */])(fromPage) ? fromPage : this.pageForThisMonth();
      let toPage = Object(helpers["a" /* addPages */])(fromPage, this.count - 1); // 6. Adjust for min/max pages if not forced

      if (!force) {
        if (Object(helpers["s" /* pageIsBeforePage */])(fromPage, this.minPage_)) {
          fromPage = this.minPage_;
        } else if (Object(helpers["r" /* pageIsAfterPage */])(toPage, this.maxPage_)) {
    ...
    getPageTransition(oldPage, newPage, transition = this.transition) {
      ...
      if (transition === 'fade' || !transition && this.count > 1 || !Object(helpers["v" /* pageIsValid */])(oldPage) || !Object(helpers["v" /* pageIsValid */])(newPage)) {
        return 'fade';
      } // Moving to a previous page


      const movePrev = Object(helpers["s" /* pageIsBeforePage */])(newPage, oldPage); // Vertical slide
  ...
  methods: {
    ...
    adjustPageRange(isStart) {
      ...
      this.$nextTick(function () {
        ...
        if (page && calendar && !Object(helpers["t" /* pageIsBetweenPages */])(page, calendar.firstPage, calendar.lastPage)) {
          calendar.move(page, {
            position,
            transition: 'fade'
          });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return pageIsValid; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return mergeEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return pageIsBeforePage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return pageIsAfterPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return pageIsBetweenPages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return pageIsEqualToPage; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "D", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["pageIsAfterPage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "E", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["pageIsBeforePage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "F", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["pageIsBetweenPages"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "G", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["pageIsEqualToPage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "H", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["pageIsValid"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "I", function() { return _utils__WEBPACK_IMPORTED_MODULE_2__["setupCalendar"]; });
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarPane_vue_vue_type_style_index_0_id_ea3333ec_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("693e");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarPane_vue_vue_type_style_index_0_id_ea3333ec_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarPane_vue_vue_type_style_index_0_id_ea3333ec_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarPane_vue_vue_type_style_index_0_id_ea3333ec_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_4bf08813_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("9e40");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_4bf08813_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_4bf08813_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CalendarDay_vue_vue_type_style_index_0_id_4bf08813_lang_postcss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("3cc0");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("90284800", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__("f09c");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0eb9f63c", content, true, {"sourceMap":false,"shadowMode":false});
...
__webpack_require__.d(__webpack_exports__, "pageIsValid", function() { return /* reexport */ helpers["v" /* pageIsValid */]; });
__webpack_require__.d(__webpack_exports__, "mergeEvents", function() { return /* reexport */ helpers["l" /* mergeEvents */]; });
__webpack_require__.d(__webpack_exports__, "pageIsBeforePage", function() { return /* reexport */ helpers["s" /* pageIsBeforePage */]; });
__webpack_require__.d(__webpack_exports__, "pageIsAfterPage", function() { return /* reexport */ helpers["r" /* pageIsAfterPage */]; });
__webpack_require__.d(__webpack_exports__, "pageIsBetweenPages", function() { return /* reexport */ helpers["t" /* pageIsBetweenPages */]; });
__webpack_require__.d(__webpack_exports__, "pageIsEqualToPage", function() { return /* reexport */ helpers["u" /* pageIsEqualToPage */]; });
...
__webpack_require__.d(__webpack_exports__, "pageIsValid", function() { return /* reexport */ lib["H" /* pageIsValid */]; });
__webpack_require__.d(__webpack_exports__, "mergeEvents", function() { return /* reexport */ lib["x" /* mergeEvents */]; });
__webpack_require__.d(__webpack_exports__, "pageIsBeforePage", function() { return /* reexport */ lib["E" /* pageIsBeforePage */]; });
__webpack_require__.d(__webpack_exports__, "pageIsAfterPage", function() { return /* reexport */ lib["D" /* pageIsAfterPage */]; });
__webpack_require__.d(__webpack_exports__, "pageIsBetweenPages", function() { return /* reexport */ lib["F" /* pageIsBetweenPages */]; });
__webpack_require__.d(__webpack_exports__, "pageIsEqualToPage", function() { return /* reexport */ lib["G" /* pageIsEqualToPage */]; });
